...
public class LecturerCreateStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lecturer_create_student);
            ...
            users.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.child(user.getUsername()).exists()){
                        Toast.makeText(LecturerCreateStudentActivity.this, "Username already exist!", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                    else{
                        users.child(user.getUsername()).setValue(user);
                        Toast.makeText(LecturerCreateStudentActivity.this, "Student created successfully!", Toast.LENGTH_SHORT).show();
