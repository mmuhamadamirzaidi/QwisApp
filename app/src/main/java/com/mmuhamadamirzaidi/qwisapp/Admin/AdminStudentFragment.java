...
public class AdminStudentFragment extends Fragment {
    ...
    public static AdminStudentFragment newInstance() {
        AdminStudentFragment studentFragment = new AdminStudentFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        myFragment = inflater.inflate(R.layout.fragment_admin_student, container, false);
        ...
        LecturerFabCreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent createIntent = new Intent(getActivity(), AdminCreateStudentActivity.class);
