...
public class AdminCreateStudentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_create_student);
...
//        }
        if(valid)
        {
            ...
            loadingBar.setMessage("Please wait while student account is processing...");
            loadingBar.show();
            ...
            users.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.child(user.getUsername()).exists()){
                        Toast.makeText(AdminCreateStudentActivity.this, "Username already exist!", Toast.LENGTH_SHORT).show();
                        loadingBar.dismiss();
                    }
                    else{
                        users.child(user.getUsername()).setValue(user);
                        Toast.makeText(AdminCreateStudentActivity.this, "Student created successfully!", Toast.LENGTH_SHORT).show();
                        SendToAdminHomeFragment();
                        loadingBar.dismiss();
                    }
                }
    ...
    private void SendToAdminHomeFragment() {

        Intent intent = new Intent(AdminCreateStudentActivity.this, AdminHomeActivity.class);
